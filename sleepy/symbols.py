...
SLEEPY_TYPES = {
  ...
  'DoublePtr': SLEEPY_DOUBLE_PTR, 'CharPtr': SLEEPY_CHAR_PTR, 'IntPtr': SLEEPY_INT_PTR}  # type: Dict[str, Type]
SLEEPY_NUMERICAL_TYPES = {SLEEPY_DOUBLE, SLEEPY_FLOAT, SLEEPY_INT, SLEEPY_LONG}
SLEEPY_POINTER_TYPES = {SLEEPY_DOUBLE_PTR, SLEEPY_CHAR_PTR, SLEEPY_INT_PTR}
...
SLEEPY_INBUILT_BINARY_OPS_ARG_TYPES = [
  [
    ...
    [SLEEPY_DOUBLE_PTR, SLEEPY_INT], [SLEEPY_CHAR_PTR, SLEEPY_INT], [SLEEPY_INT_PTR, SLEEPY_INT],
  ...
  [[SLEEPY_DOUBLE, SLEEPY_DOUBLE]]] + [
    [[SLEEPY_DOUBLE, SLEEPY_DOUBLE], [SLEEPY_INT, SLEEPY_INT], [SLEEPY_LONG, SLEEPY_LONG],
    [SLEEPY_DOUBLE_PTR, SLEEPY_DOUBLE_PTR], [SLEEPY_CHAR_PTR, SLEEPY_CHAR_PTR],
    [SLEEPY_INT_PTR, SLEEPY_INT_PTR]]] * 6  # type: List[List[List[Type]]]
SLEEPY_INBUILT_BINARY_OPS_RETURN_TYPES = [
  [
    SLEEPY_DOUBLE, SLEEPY_INT, SLEEPY_LONG, SLEEPY_DOUBLE_PTR, SLEEPY_CHAR_PTR, SLEEPY_INT_PTR, SLEEPY_DOUBLE,
    SLEEPY_INT, SLEEPY_LONG],
  [SLEEPY_DOUBLE, SLEEPY_INT, SLEEPY_LONG, SLEEPY_DOUBLE, SLEEPY_INT, SLEEPY_LONG],
  [SLEEPY_DOUBLE, SLEEPY_INT, SLEEPY_LONG],
  [SLEEPY_DOUBLE]] + [[SLEEPY_BOOL] * 6] * 6  # type: List[List[Type]]
assert (
